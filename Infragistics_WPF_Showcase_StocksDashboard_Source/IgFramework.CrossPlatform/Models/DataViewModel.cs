...
namespace Infragistics.Framework
{
    ...
    public class DataViewModel : ObservableObject
    {
        public DataViewModel()
        {
            ...
            Indicators = new Dictionary<string, DataIndicator>();

           // var vc = new CollectionViewSource();
        ...
        /// </summary>
        public Dictionary<string, DataIndicator> Indicators { get; private set; }
        /// <summary>
        ...
        /// </summary>
        public List<DataIndicator> IndicatorsList
        {
        ...
        private void UpdateIndicators(object item)
        {
            ...
            foreach (var property in properties)
            {
                ...
                if (double.IsNaN(value))
                {
                    ...
                    {
                        var column = new DataColumn { Label = name, Key = name };
                ...
                else
                {
                    ...
                    {
                        var indicator = new DataIndicator { Label = name, Key = name };
                        if (!double.IsNaN(value))
                        {
                            indicator.Min = value;
                            indicator.Max = value;
