...
namespace Infragistics.Framework
{
    ...
    { 
        ...
        public StockPriceList(int itemsCount)
        {
        ...
        public StockPriceItem GenerateItem(double close, double volume, DateTime date)
        {
        ...
        public StockPriceItem GenerateItem(StockPriceItem previous)
        {
    ...
    public class StockPriceItem
    {
        ...
        public StockPriceItem(StockPriceItem stock)
        {
            Symbol = stock.Symbol;
            Split = stock.Split;
